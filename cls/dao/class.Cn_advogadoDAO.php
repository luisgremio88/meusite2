<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_advogado" 
 */
class Cn_advogadoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_advogado
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_advogado
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$AdvogadoId = $obj->getAdvogadoid();
		$Nome = $obj->getNome();
		$Texto = $obj->getTexto();
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_advogado
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_advogado conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_advogado $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_advogado
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_advogado WHERE Field = '".$coluna."'");
