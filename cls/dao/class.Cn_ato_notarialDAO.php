<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_ato_notarial" 
 */
class Cn_ato_notarialDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_ato_notarial
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_ato_notarial 
				(
				Titulo,
				Texto
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_ato_notarial
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$AtoNotarialId = $obj->getAtonotarialid();
		...
		//montar o comando SQL
        $sql = "update cn_ato_notarial set
				$campos
				where AtoNotarialId = $AtoNotarialId";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_ato_notarial
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_ato_notarial 
				where AtoNotarialId = $AtoNotarialId";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_ato_notarial conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_ato_notarial $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_ato_notarial
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_ato_notarial WHERE Field = '".$coluna."'");
