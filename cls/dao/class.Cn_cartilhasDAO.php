<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_cartilhas" 
 */
class Cn_cartilhasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_cartilhas
	 */
	public function insert($obj) {
		...
		$pdf = $this->dba->quote($obj->getPdf());
		
		//montar o comando SQL
		$sql = "insert into cn_cartilhas 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_cartilhas
	...
	public function update($obj) {
        ...
        if (!empty($pdf) || is_numeric($pdf)) {
        	$campos .= "pdf=".$this->dba->quote($pdf).", ";
        }
        $campos = substr($campos,0,strrpos($campos,','));
        
		//montar o comando SQL
        $sql = "update cn_cartilhas set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_cartilhas
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_cartilhas conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_cartilhas $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_cartilhas
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_cartilhas WHERE Field = '".$coluna."'");
