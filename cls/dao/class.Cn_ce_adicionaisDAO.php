<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_ce_adicionais" 
 */
class Cn_ce_adicionaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_ce_adicionais
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$id_inscricao = $this->dba->quote($obj->getId_inscricao());
		$nome = $this->dba->quote($obj->getNome());
		$tipo = $this->dba->quote($obj->getTipo());
		$funcao = $this->dba->quote($obj->getFuncao());
		
		//montar o comando SQL
		$sql = "insert into cn_ce_adicionais 
				(
				id_inscricao,
				nome,
				tipo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_ce_adicionais
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$id = $obj->getId();
		$id_inscricao = $obj->getId_inscricao();
		$nome = $obj->getNome();
		$tipo = $obj->getTipo();
		$funcao = $obj->getFuncao();
		
        $campos = '';
        if (!empty($id_inscricao) || is_numeric($id_inscricao)) {
        	$campos .= "id_inscricao=".$this->dba->quote($id_inscricao).", ";
        }
		...
		//montar o comando SQL
        $sql = "update cn_ce_adicionais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_ce_adicionais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_ce_adicionais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_ce_adicionais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_ce_adicionais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_ce_adicionais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_ce_adicionais WHERE Field = '".$coluna."'");
