<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_codigos_bancos_brasil" 
 */
class Cn_codigos_bancos_brasilDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_codigos_bancos_brasil
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_codigos_bancos_brasil 
				(
				numero,
				nome
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_codigos_bancos_brasil
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_codigos_bancos_brasil set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_codigos_bancos_brasil
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_codigos_bancos_brasil 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_codigos_bancos_brasil conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_codigos_bancos_brasil $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_codigos_bancos_brasil
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_codigos_bancos_brasil WHERE Field = '".$coluna."'");
