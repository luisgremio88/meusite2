<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_contas_pagar" 
 */
class Cn_contas_pagarDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_contas_pagar
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_contas_pagar 
				(
				descricao,
				pagador_usuario,
				pagador_cliente,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_contas_pagar
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_contas_pagar set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_contas_pagar
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_contas_pagar 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_contas_pagar conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_contas_pagar $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_contas_pagar
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_contas_pagar WHERE Field = '".$coluna."'");
