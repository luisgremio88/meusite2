<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_contas_receber_subcategorias" 
 */
class Cn_contas_receber_subcategoriasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_contas_receber_subcategorias
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_contas_receber_subcategorias 
				(
				nome,
				categoria,
				observacao
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_contas_receber_subcategorias
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_contas_receber_subcategorias set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_contas_receber_subcategorias
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_contas_receber_subcategorias 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_contas_receber_subcategorias conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_contas_receber_subcategorias $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_contas_receber_subcategorias
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_contas_receber_subcategorias WHERE Field = '".$coluna."'");
