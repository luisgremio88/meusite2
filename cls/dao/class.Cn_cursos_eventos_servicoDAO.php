<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_cursos_eventos_servico" 
 */
class Cn_cursos_eventos_servicoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_cursos_eventos_servico
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$id_curso_evento = $this->dba->quote($obj->getId_curso_evento());
		$id_evento_servico = $this->dba->quote($obj->getId_evento_servico());
		$status = $this->dba->quote($obj->getStatus());
		
		//montar o comando SQL
		$sql = "insert into cn_cursos_eventos_servico 
				(
				id_curso_evento,
				id_evento_servico,
				status
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_cursos_eventos_servico
	...
	public function update($obj) {
		...
		$id_evento_servico = $obj->getId_evento_servico();
        ...
        if (!empty($id_evento_servico) || is_numeric($id_evento_servico)) {
        	$campos .= "id_evento_servico=".$this->dba->quote($id_evento_servico).", ";
        }
		...
		//montar o comando SQL
        $sql = "update cn_cursos_eventos_servico set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_cursos_eventos_servico
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_cursos_eventos_servico 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_cursos_eventos_servico conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_cursos_eventos_servico $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_cursos_eventos_servico
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_cursos_eventos_servico WHERE Field = '".$coluna."'");
