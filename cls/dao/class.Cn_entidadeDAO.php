<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_entidade" 
 */
class Cn_entidadeDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_entidade
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$EntidadeId = $this->dba->quote($obj->getEntidadeid());
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_entidade
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$EntidadeId = $obj->getEntidadeid();
		$Nome = $obj->getNome();
        ...
        $campos = '';
        if (!empty($EntidadeId) || is_numeric($EntidadeId)) {
        	$campos .= "EntidadeId=".$this->dba->quote($EntidadeId).", ";
        }
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_entidade
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_entidade conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_entidade $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_entidade
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_entidade WHERE Field = '".$coluna."'");
