<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_evento_participante_tipo" 
 */
class Cn_evento_participante_tipoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_evento_participante_tipo
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_evento_participante_tipo 
				(
				nome
				) 
				values 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_evento_participante_tipo
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_evento_participante_tipo set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_evento_participante_tipo
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_evento_participante_tipo 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_evento_participante_tipo conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_evento_participante_tipo $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_evento_participante_tipo
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_evento_participante_tipo WHERE Field = '".$coluna."'");
