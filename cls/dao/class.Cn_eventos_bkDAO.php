<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_eventos_bk" 
 */
class Cn_eventos_bkDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_eventos_bk
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_eventos_bk
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_eventos_bk
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_eventos_bk conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_eventos_bk $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_eventos_bk
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_eventos_bk WHERE Field = '".$coluna."'");
