<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_galeria_fotos" 
 */
class Cn_galeria_fotosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_galeria_fotos
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$anexo = $this->dba->quote($obj->getAnexo());
		$id_galeria_fotos_evento = $this->dba->quote($obj->getId_galeria_fotos_evento());
		
		//montar o comando SQL
		$sql = "insert into cn_galeria_fotos 
				(
				anexo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_galeria_fotos
	...
	public function update($obj) {
		...
		$id = $obj->getId();
		$anexo = $obj->getAnexo();
		$id_galeria_fotos_evento = $obj->getId_galeria_fotos_evento();
		
        $campos = '';
        if (!empty($anexo) || is_numeric($anexo)) {
        	$campos .= "anexo=".$this->dba->quote($anexo).", ";
        }
        if (!empty($id_galeria_fotos_evento) || is_numeric($id_galeria_fotos_evento)) {
        	$campos .= "id_galeria_fotos_evento=".$this->dba->quote($id_galeria_fotos_evento).", ";
        }
        $campos = substr($campos,0,strrpos($campos,','));
        
		//montar o comando SQL
        $sql = "update cn_galeria_fotos set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_galeria_fotos
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_galeria_fotos 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_galeria_fotos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_galeria_fotos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_galeria_fotos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_galeria_fotos WHERE Field = '".$coluna."'");
