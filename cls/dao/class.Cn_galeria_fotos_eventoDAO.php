<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_galeria_fotos_evento" 
 */
class Cn_galeria_fotos_eventoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_galeria_fotos_evento
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_galeria_fotos_evento 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_galeria_fotos_evento
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_galeria_fotos_evento set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_galeria_fotos_evento
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_galeria_fotos_evento 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_galeria_fotos_evento conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_galeria_fotos_evento $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_galeria_fotos_evento
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_galeria_fotos_evento WHERE Field = '".$coluna."'");
