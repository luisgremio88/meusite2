<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_institucional_diretoria" 
 */
class Cn_institucional_diretoriaDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_institucional_diretoria
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_institucional_diretoria 
				(
				titulo,
				texto,
				anexo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_institucional_diretoria
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_institucional_diretoria set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_institucional_diretoria
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_institucional_diretoria 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_institucional_diretoria conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_institucional_diretoria $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_institucional_diretoria
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_institucional_diretoria WHERE Field = '".$coluna."'");
