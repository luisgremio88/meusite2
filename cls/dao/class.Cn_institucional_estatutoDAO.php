<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_institucional_estatuto" 
 */
class Cn_institucional_estatutoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_institucional_estatuto
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_institucional_estatuto 
				(
				titulo,
				texto,
				anexo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_institucional_estatuto
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_institucional_estatuto set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_institucional_estatuto
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_institucional_estatuto 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_institucional_estatuto conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_institucional_estatuto $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_institucional_estatuto
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_institucional_estatuto WHERE Field = '".$coluna."'");
