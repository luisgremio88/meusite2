<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_institucional_ex_presidentes_membros" 
 */
class Cn_institucional_ex_presidentes_membrosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_institucional_ex_presidentes_membros
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$nome = $this->dba->quote($obj->getNome());
		$periodo = $this->dba->quote($obj->getPeriodo());
		$descricao = $this->dba->quote($obj->getDescricao());
		$ordem = $this->dba->quote($obj->getOrdem());
		$status = $this->dba->quote($obj->getStatus());
		
		//montar o comando SQL
		$sql = "insert into cn_institucional_ex_presidentes_membros 
				(
				nome,
				periodo,
				descricao,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_institucional_ex_presidentes_membros
	...
	public function update($obj) {
        ...
        if (!empty($periodo) || is_numeric($periodo)) {
        	$campos .= "periodo=".$this->dba->quote($periodo).", ";
        }
		...
		//montar o comando SQL
        $sql = "update cn_institucional_ex_presidentes_membros set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_institucional_ex_presidentes_membros
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_institucional_ex_presidentes_membros 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_institucional_ex_presidentes_membros conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_institucional_ex_presidentes_membros $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_institucional_ex_presidentes_membros
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_institucional_ex_presidentes_membros WHERE Field = '".$coluna."'");
