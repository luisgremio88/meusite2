<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_institucional_quem_somos" 
 */
class Cn_institucional_quem_somosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_institucional_quem_somos
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_institucional_quem_somos 
				(
				titulo,
				texto,
				anexo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_institucional_quem_somos
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_institucional_quem_somos set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_institucional_quem_somos
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_institucional_quem_somos 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_institucional_quem_somos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_institucional_quem_somos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_institucional_quem_somos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_institucional_quem_somos WHERE Field = '".$coluna."'");
