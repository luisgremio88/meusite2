<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_institucional_sede" 
 */
class Cn_institucional_sedeDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_institucional_sede
	 */
	public function insert($obj) {
		...
		$mapa = $this->dba->quote($obj->getMapa());
		
		//montar o comando SQL
		$sql = "insert into cn_institucional_sede 
				(
				titulo,
				texto,
				anexo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_institucional_sede
	...
	public function update($obj) {
        ...
        if (!empty($mapa) || is_numeric($mapa)) {
        	$campos .= "mapa=".$this->dba->quote($mapa).", ";
        }
        $campos = substr($campos,0,strrpos($campos,','));
        
		//montar o comando SQL
        $sql = "update cn_institucional_sede set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_institucional_sede
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_institucional_sede 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_institucional_sede conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_institucional_sede $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_institucional_sede
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_institucional_sede WHERE Field = '".$coluna."'");
