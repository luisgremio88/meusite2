<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_jornalistas" 
 */
class Cn_jornalistasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_jornalistas
	...
	public function update($obj) {
        ...
        if (!empty($veiculo) || is_numeric($veiculo)) {
        	$campos .= "veiculo=".$this->dba->quote($veiculo).", ";
        }
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_jornalistas
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_jornalistas 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_jornalistas conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_jornalistas $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_jornalistas
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_jornalistas WHERE Field = '".$coluna."'");
