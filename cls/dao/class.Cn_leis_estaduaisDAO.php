<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_leis_estaduais" 
 */
class Cn_leis_estaduaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_leis_estaduais
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_leis_estaduais 
				(
				titulo,
				texto,
				anexo,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_leis_estaduais
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_leis_estaduais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_leis_estaduais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_leis_estaduais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_leis_estaduais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_leis_estaduais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_leis_estaduais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_leis_estaduais WHERE Field = '".$coluna."'");
