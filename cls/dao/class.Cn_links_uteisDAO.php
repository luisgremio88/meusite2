<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_links_uteis" 
 */
class Cn_links_uteisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_links_uteis
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$TipoLink = $this->dba->quote($obj->getTipolink());
		...
		$sql = "insert into cn_links_uteis 
				(
				TipoLink,
				titulo,
				link,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_links_uteis
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$id = $obj->getId();
		$TipoLink = $obj->getTipolink();
        ...
        $campos = '';
        if (!empty($TipoLink) || is_numeric($TipoLink)) {
        	$campos .= "TipoLink=".$this->dba->quote($TipoLink).", ";
        }
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_links_uteis
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_links_uteis 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_links_uteis conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_links_uteis $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_links_uteis
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_links_uteis WHERE Field = '".$coluna."'");
