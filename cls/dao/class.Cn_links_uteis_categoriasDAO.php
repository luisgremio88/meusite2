<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_links_uteis_categorias" 
 */
class Cn_links_uteis_categoriasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_links_uteis_categorias
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_links_uteis_categorias 
				(
				titulo,
				status
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_links_uteis_categorias
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_links_uteis_categorias set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_links_uteis_categorias
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_links_uteis_categorias 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_links_uteis_categorias conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_links_uteis_categorias $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_links_uteis_categorias
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_links_uteis_categorias WHERE Field = '".$coluna."'");
