<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_mensagens" 
 */
class Cn_mensagensDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_mensagens
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_mensagens
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_mensagens
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_mensagens conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_mensagens $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_mensagens
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_mensagens WHERE Field = '".$coluna."'");
