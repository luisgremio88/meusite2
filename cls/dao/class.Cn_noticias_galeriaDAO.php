<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_noticias_galeria" 
 */
class Cn_noticias_galeriaDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_noticias_galeria
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$anexo = $this->dba->quote($obj->getAnexo());
		$id_noticia = $this->dba->quote($obj->getId_noticia());
		
		//montar o comando SQL
		$sql = "insert into cn_noticias_galeria 
				(
				anexo,
				id_noticia
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_noticias_galeria
	...
	public function update($obj) {
        ...
        if (!empty($id_noticia) || is_numeric($id_noticia)) {
        	$campos .= "id_noticia=".$this->dba->quote($id_noticia).", ";
        }
        $campos = substr($campos,0,strrpos($campos,','));
        
		//montar o comando SQL
        $sql = "update cn_noticias_galeria set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_noticias_galeria
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_noticias_galeria 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_noticias_galeria conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_noticias_galeria $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_noticias_galeria
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_noticias_galeria WHERE Field = '".$coluna."'");
