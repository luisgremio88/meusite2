<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_palestrante" 
 */
class Cn_palestranteDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_palestrante
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_palestrante 
				(
				Nome,
				Descricao,
				Site
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_palestrante
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$PalestranteId = $obj->getPalestranteid();
		$Nome = $obj->getNome();
		...
		//montar o comando SQL
        $sql = "update cn_palestrante set
				$campos
				where PalestranteId = $PalestranteId";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_palestrante
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_palestrante 
				where PalestranteId = $PalestranteId";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_palestrante conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_palestrante $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_palestrante
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_palestrante WHERE Field = '".$coluna."'");
