<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_plano_de_contas_categorias" 
 */
class Cn_plano_de_contas_categoriasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_plano_de_contas_categorias
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_plano_de_contas_categorias 
				(
				nome,
				observacao
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_plano_de_contas_categorias
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_plano_de_contas_categorias set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_plano_de_contas_categorias
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_plano_de_contas_categorias 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_plano_de_contas_categorias conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_plano_de_contas_categorias $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_plano_de_contas_categorias
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_plano_de_contas_categorias WHERE Field = '".$coluna."'");
