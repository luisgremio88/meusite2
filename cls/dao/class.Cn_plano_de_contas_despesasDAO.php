<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_plano_de_contas_despesas" 
 */
class Cn_plano_de_contas_despesasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_plano_de_contas_despesas
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_plano_de_contas_despesas 
				(
				nome,
				categoria,
				observacao
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_plano_de_contas_despesas
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_plano_de_contas_despesas set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_plano_de_contas_despesas
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_plano_de_contas_despesas 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_plano_de_contas_despesas conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_plano_de_contas_despesas $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_plano_de_contas_despesas
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_plano_de_contas_despesas WHERE Field = '".$coluna."'");
