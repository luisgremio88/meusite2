<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_relatorio_eventos" 
 */
class Cn_relatorio_eventosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_relatorio_eventos
	 */
	public function insert($obj) {
		//pegar os dados do objeto
		$nome_evento = $this->dba->quote($obj->getNome_evento());
		...
		$sql = "insert into cn_relatorio_eventos 
				(
				nome_evento,
				valor,
				descricao,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_relatorio_eventos
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$id = $obj->getId();
		$nome_evento = $obj->getNome_evento();
		$valor = $obj->getValor();
		$descricao = $obj->getDescricao();
		$data_cadastro = $obj->getData_cadastro();
		
        $campos = '';
        if (!empty($nome_evento) || is_numeric($nome_evento)) {
        	$campos .= "nome_evento=".$this->dba->quote($nome_evento).", ";
        }
		...
		//montar o comando SQL
        $sql = "update cn_relatorio_eventos set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_relatorio_eventos
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_relatorio_eventos 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_relatorio_eventos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_relatorio_eventos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_relatorio_eventos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_relatorio_eventos WHERE Field = '".$coluna."'");
