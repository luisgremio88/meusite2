<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_revistas" 
 */
class Cn_revistasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_revistas
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_revistas
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_revistas
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_revistas conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_revistas $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_revistas
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_revistas WHERE Field = '".$coluna."'");
