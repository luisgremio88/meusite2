<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_sala_de_imprensa" 
 */
class Cn_sala_de_imprensaDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_sala_de_imprensa
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_sala_de_imprensa 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_sala_de_imprensa
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_sala_de_imprensa set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_sala_de_imprensa
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_sala_de_imprensa 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_sala_de_imprensa conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_sala_de_imprensa $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_sala_de_imprensa
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_sala_de_imprensa WHERE Field = '".$coluna."'");
