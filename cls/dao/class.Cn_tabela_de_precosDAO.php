<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_tabela_de_precos" 
 */
class Cn_tabela_de_precosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_tabela_de_precos
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_tabela_de_precos 
				(
				titulo,
				valor
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_tabela_de_precos
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_tabela_de_precos set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_tabela_de_precos
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_tabela_de_precos 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_tabela_de_precos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_tabela_de_precos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_tabela_de_precos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_tabela_de_precos WHERE Field = '".$coluna."'");
