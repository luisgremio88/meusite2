<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_tabela_emolumentos" 
 */
class Cn_tabela_emolumentosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_tabela_emolumentos
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_tabela_emolumentos 
				(
				Ano,
				Titulo
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_tabela_emolumentos
	 * para remover o valor de uma coluna, atribua a string '!NULL!'
	 */
	public function update($obj) {
		//pegar os dados do objeto
		$TabelaEmolumentosId = $obj->getTabelaemolumentosid();
		$Ano = $obj->getAno();
		...
		//montar o comando SQL
        $sql = "update cn_tabela_emolumentos set
				$campos
				where TabelaEmolumentosId = $TabelaEmolumentosId";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_tabela_emolumentos
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_tabela_emolumentos 
				where TabelaEmolumentosId = $TabelaEmolumentosId";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_tabela_emolumentos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_tabela_emolumentos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_tabela_emolumentos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_tabela_emolumentos WHERE Field = '".$coluna."'");
