<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_testamento_tipo" 
 */
class Cn_testamento_tipoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_testamento_tipo
	 */
	public function insert($obj) {
		...
		$sql = "insert into cn_testamento_tipo 
				(
				Nome,
				TestamentoTipoXML
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_testamento_tipo
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cn_testamento_tipo set
				$campos
				where TestamentoTipoId = $TestamentoTipoId";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_testamento_tipo
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_testamento_tipo 
				where TestamentoTipoId = $TestamentoTipoId";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_testamento_tipo conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_testamento_tipo $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_testamento_tipo
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_testamento_tipo WHERE Field = '".$coluna."'");
