<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_testamentos" 
 */
class Cn_testamentosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_testamentos
	 */
	public function insert($obj) {
		...
		$TestamentoTipoId = $this->dba->quote($obj->getTestamentotipoid());
		$TestamentoImportacaoId = $this->dba->quote($obj->getTestamentoimportacaoid());
		$Ativo = $this->dba->quote($obj->getAtivo());
		$arquivo_motivo_desativo = $this->dba->quote($obj->getArquivo_motivo_desativo());
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_testamentos
	...
	public function update($obj) {
		...
		$TestamentoTipoId = $obj->getTestamentotipoid();
		$TestamentoImportacaoId = $obj->getTestamentoimportacaoid();
		$Ativo = $obj->getAtivo();
		$arquivo_motivo_desativo = $obj->getArquivo_motivo_desativo();
        ...
        if (!empty($TestamentoTipoId) || is_numeric($TestamentoTipoId)) {
        	$campos .= "TestamentoTipoId=".$this->dba->quote($TestamentoTipoId).", ";
        }
        if (!empty($TestamentoImportacaoId) || is_numeric($TestamentoImportacaoId)) {
        	$campos .= "TestamentoImportacaoId=".$this->dba->quote($TestamentoImportacaoId).", ";
        }
        if (!empty($Ativo) || is_numeric($Ativo)) {
        	$campos .= "Ativo=".$this->dba->quote($Ativo).", ";
        }
        if (!empty($arquivo_motivo_desativo) || is_numeric($arquivo_motivo_desativo)) {
        	$campos .= "arquivo_motivo_desativo=".$this->dba->quote($arquivo_motivo_desativo).", ";
        }
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_testamentos
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_testamentos 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_testamentos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_testamentos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_testamentos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_testamentos WHERE Field = '".$coluna."'");
