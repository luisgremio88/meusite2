<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cn_usuarios_associados" 
 */
class Cn_usuarios_associadosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cn_usuarios_associados
	 */
	public function insert($obj) {
		...
		$TokenCertificado = $this->dba->quote($obj->getTokencertificado());
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cn_usuarios_associados
	...
	public function update($obj) {
		...
		$Tipo = $obj->getTipo();
		$TokenCertificado = $obj->getTokencertificado();
        ...
        if (!empty($TokenCertificado) || is_numeric($TokenCertificado)) {
        	$campos .= "TokenCertificado=".$this->dba->quote($TokenCertificado).", ";
        }
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cn_usuarios_associados
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cn_usuarios_associados 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cn_usuarios_associados conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cn_usuarios_associados $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cn_usuarios_associados
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cn_usuarios_associados WHERE Field = '".$coluna."'");
