<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_atas_reuniao" 
 */
class Cr_atas_reuniaoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_atas_reuniao
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_atas_reuniao 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_atas_reuniao
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_atas_reuniao set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_atas_reuniao
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_atas_reuniao 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_atas_reuniao conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_atas_reuniao $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_atas_reuniao
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_atas_reuniao WHERE Field = '".$coluna."'");
