<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_atos_registrais" 
 */
class Cr_atos_registraisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_atos_registrais
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_atos_registrais 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_atos_registrais
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_atos_registrais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_atos_registrais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_atos_registrais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_atos_registrais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_atos_registrais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_atos_registrais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_atos_registrais WHERE Field = '".$coluna."'");
