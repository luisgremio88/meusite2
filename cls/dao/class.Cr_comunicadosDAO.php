<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_comunicados" 
 */
class Cr_comunicadosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_comunicados
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_comunicados 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_comunicados
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_comunicados
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_comunicados 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_comunicados conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_comunicados $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_comunicados
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_comunicados WHERE Field = '".$coluna."'");
