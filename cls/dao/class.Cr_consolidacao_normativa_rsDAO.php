<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_consolidacao_normativa_rs" 
 */
class Cr_consolidacao_normativa_rsDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_consolidacao_normativa_rs
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_consolidacao_normativa_rs 
				(
				link
				) 
				values 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_consolidacao_normativa_rs
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_consolidacao_normativa_rs set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_consolidacao_normativa_rs
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_consolidacao_normativa_rs 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_consolidacao_normativa_rs conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_consolidacao_normativa_rs $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_consolidacao_normativa_rs
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_consolidacao_normativa_rs WHERE Field = '".$coluna."'");
