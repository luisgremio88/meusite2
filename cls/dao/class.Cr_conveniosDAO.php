<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_convenios" 
 */
class Cr_conveniosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_convenios
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_convenios
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_convenios
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_convenios conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_convenios $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_convenios
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_convenios WHERE Field = '".$coluna."'");
