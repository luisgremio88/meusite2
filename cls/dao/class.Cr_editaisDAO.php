<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_editais" 
 */
class Cr_editaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_editais
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_editais
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_editais
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_editais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_editais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_editais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_editais WHERE Field = '".$coluna."'");
