<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_ex_presidentes" 
 */
class Cr_ex_presidentesDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_ex_presidentes
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_ex_presidentes 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_ex_presidentes
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_ex_presidentes set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_ex_presidentes
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_ex_presidentes 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_ex_presidentes conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_ex_presidentes $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_ex_presidentes
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_ex_presidentes WHERE Field = '".$coluna."'");
