<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_jurisprudencias" 
 */
class Cr_jurisprudenciasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_jurisprudencias
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_jurisprudencias 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_jurisprudencias
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_jurisprudencias set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_jurisprudencias
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_jurisprudencias 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_jurisprudencias conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_jurisprudencias $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_jurisprudencias
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_jurisprudencias WHERE Field = '".$coluna."'");
