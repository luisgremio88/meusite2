<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_leis_estaduais" 
 */
class Cr_leis_estaduaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_leis_estaduais
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_leis_estaduais 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_leis_estaduais
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_leis_estaduais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_leis_estaduais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_leis_estaduais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_leis_estaduais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_leis_estaduais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_leis_estaduais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_leis_estaduais WHERE Field = '".$coluna."'");
