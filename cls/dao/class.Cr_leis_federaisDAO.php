<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_leis_federais" 
 */
class Cr_leis_federaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_leis_federais
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_leis_federais 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_leis_federais
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_leis_federais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_leis_federais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_leis_federais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_leis_federais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_leis_federais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_leis_federais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_leis_federais WHERE Field = '".$coluna."'");
