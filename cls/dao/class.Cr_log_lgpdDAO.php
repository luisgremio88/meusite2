<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_log_lgpd" 
 */
class Cr_log_lgpdDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_log_lgpd
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_log_lgpd
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_log_lgpd
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_log_lgpd conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_log_lgpd $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_log_lgpd
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_log_lgpd WHERE Field = '".$coluna."'");
