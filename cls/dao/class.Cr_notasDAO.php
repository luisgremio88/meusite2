<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_notas" 
 */
class Cr_notasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_notas
	 */
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_notas
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_notas
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_notas conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_notas $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_notas
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_notas WHERE Field = '".$coluna."'");
