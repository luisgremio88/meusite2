<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_notas_expedientes" 
 */
class Cr_notas_expedientesDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_notas_expedientes
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_notas_expedientes 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_notas_expedientes
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_notas_expedientes set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_notas_expedientes
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_notas_expedientes 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_notas_expedientes conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_notas_expedientes $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_notas_expedientes
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_notas_expedientes WHERE Field = '".$coluna."'");
