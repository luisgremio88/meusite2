<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_perguntas_respostas_categorias" 
 */
class Cr_perguntas_respostas_categoriasDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_perguntas_respostas_categorias
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_perguntas_respostas_categorias 
				(
				titulo,
				status
				) 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_perguntas_respostas_categorias
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_perguntas_respostas_categorias set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_perguntas_respostas_categorias
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_perguntas_respostas_categorias 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_perguntas_respostas_categorias conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_perguntas_respostas_categorias $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_perguntas_respostas_categorias
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_perguntas_respostas_categorias WHERE Field = '".$coluna."'");
