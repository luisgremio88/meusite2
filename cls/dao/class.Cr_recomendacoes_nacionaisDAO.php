<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_recomendacoes_nacionais" 
 */
class Cr_recomendacoes_nacionaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_recomendacoes_nacionais
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_recomendacoes_nacionais 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_recomendacoes_nacionais
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_recomendacoes_nacionais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_recomendacoes_nacionais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_recomendacoes_nacionais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_recomendacoes_nacionais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_recomendacoes_nacionais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_recomendacoes_nacionais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_recomendacoes_nacionais WHERE Field = '".$coluna."'");
