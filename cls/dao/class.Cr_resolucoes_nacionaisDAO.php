<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_resolucoes_nacionais" 
 */
class Cr_resolucoes_nacionaisDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_resolucoes_nacionais
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_resolucoes_nacionais 
				(
				data,
				titulo,
				texto,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_resolucoes_nacionais
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_resolucoes_nacionais set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_resolucoes_nacionais
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_resolucoes_nacionais 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_resolucoes_nacionais conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_resolucoes_nacionais $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_resolucoes_nacionais
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_resolucoes_nacionais WHERE Field = '".$coluna."'");
