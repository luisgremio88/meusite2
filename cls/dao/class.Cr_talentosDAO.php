<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_talentos" 
 */
class Cr_talentosDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_talentos
	 */
	public function insert($obj) {
		...
		$curriculo = $this->dba->quote($obj->getCurriculo());
		$data_registro = $this->dba->quote($obj->getData_registro());
		
		//montar o comando SQL
		$sql = "insert into cr_talentos 
				(
				nome,
				email,
				telefone,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_talentos
	...
	public function update($obj) {
        ...
        if (!empty($curriculo) || is_numeric($curriculo)) {
        	$campos .= "curriculo=".$this->dba->quote($curriculo).", ";
        }
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_talentos
	 */
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_talentos conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_talentos $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_talentos
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_talentos WHERE Field = '".$coluna."'");
