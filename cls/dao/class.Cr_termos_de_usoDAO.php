<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Cr_termos_de_uso" 
 */
class Cr_termos_de_usoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Cr_termos_de_uso
	 */
	public function insert($obj) {
		...
		$sql = "insert into cr_termos_de_uso 
				(
				texto
				) 
				values 
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Cr_termos_de_uso
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update cr_termos_de_uso set
				$campos
				where id = $id";
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Cr_termos_de_uso
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from cr_termos_de_uso 
				where id = $id";
	...
	/**
	 * metodo que retorna os regsitros da tabela Cr_termos_de_uso conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from cr_termos_de_uso $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Cr_termos_de_uso
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM cr_termos_de_uso WHERE Field = '".$coluna."'");
