<?php
		/**
 * Classe que representa os comandos de acesso aos dados da tabela "Testamentohistorico" 
 */
class TestamentohistoricoDAO extends PDO
{
	/**
	...
	/**
	 * metodo que faz a insercao de um registro na tabela Testamentohistorico
	 */
	public function insert($obj) {
		...
		$sql = "insert into TestamentoHistorico 
				(
				TestamentoTipoXML,
				Nome,
				DataNascimento,
	...
	/**
	 * metodo que faz a atualizacao de um registro na tabela Testamentohistorico
	...
	public function update($obj) {
		...
		//montar o comando SQL
        $sql = "update TestamentoHistorico set
				$campos
	...
	/**
	 * metodo que faz a exclusao de um registro na tabela Testamentohistorico
	 */
	public function delete($obj) {
		...
		//montar o comando SQL
		$sql = "delete from TestamentoHistorico 
				where TestamentoHistoricoId = $TestamentoHistoricoId";
	...
	/**
	 * metodo que retorna os regsitros da tabela Testamentohistorico conforme o filtro informado
	...
	public function select($where='', $order='') {
		...
		$sql = "select * from TestamentoHistorico $where $order";
    ...
    /**
	 * metodo que retorna o ultimo id cadastrado na tabela Testamentohistorico
	 */
    ...
    public function metaValues($coluna, $primeiro = NULL, $excluir = NULL) {
		...
		$res = $this->dba->query("SHOW COLUMNS FROM TestamentoHistorico WHERE Field = '".$coluna."'");
