<?php
		/**
 * Classe que representa a tabela "Cn_usuarios_associados" 
 */
class Cn_usuarios_associados
{
	/**
	 * metodo construtor
	 */ 
	...
	// -- tokencertificado
	public function setTokencertificado($tokencertificado) {
		$this->tokencertificado = $tokencertificado;
	}
	public function getTokencertificado() {
		return $this->tokencertificado;
	}
