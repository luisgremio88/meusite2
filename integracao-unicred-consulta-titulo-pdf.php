...
if (isset($_SESSION['codtit']) && !empty($_SESSION['codtit']) )
{
    ...
    if (isset($token) && !empty($token)) 
    {
        ...
        $conn = 'https://api.e-unicred.com.br/homolog/cobranca/v2/beneficiarios/'.$codben.'/titulos/'.$codtit;
        $head = array(
        ...
        //header("Content-Disposition:attachment;filename=\"colnotrs-titulo-cobranca.pdf\"");
        //readfile("$rescob.pdf");
        echo $rescob;
    } 
    else {
...
{
    echo '<a href="integracao-unicred.php">Sem boleto para exibir. Voltar</a>';
}
?>