...
$sql2   = "SELECT * FROM cn_institucional_codigo_etica WHERE id = 1";
...
if ($qntd2 > 0) {
	...
	$imagem = "";
	if (file_exists('../img/institucional/codigo-etica/main.jpg')) {
		$imagem = 'https://colnotrs.app.br/img/institucional/codigo-etica/main.jpg';
	}
