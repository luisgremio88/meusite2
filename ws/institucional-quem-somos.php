...
$sql2   = "SELECT * FROM cn_institucional_quem_somos WHERE id = 1";
...
if ($qntd2 > 0) {
	...
	$imagem = "";
	if (file_exists('../img/institucional/quem-somos/main.jpg')) {
		$imagem = 'https://colnotrs.app.br/img/institucional/quem-somos/main.jpg';
	}
