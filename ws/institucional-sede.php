...
$sql2   = "SELECT * FROM cn_institucional_sede WHERE id = 1";
...
if ($qntd2 > 0) {
	...
	$imagem = "";
	if (file_exists('../img/institucional/sede/main.jpg')) {
		$imagem = 'https://colnotrs.app.br/img/institucional/sede/main.jpg';
	}
